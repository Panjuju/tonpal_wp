    ...
    <section class="web_main page_main">
        <div class="layout">
            ...
            <article class="entry blog-article">
                ...
                <div class="news_list" style="    padding-top: 20px;">
                    <?php if ( have_posts() ) { ?>
                        <ul>
                            ...
                            <li class="blog_item" style="overflow: hidden;margin-top: 10px;border-bottom: 1px solid #ddd;">
                                    <figure class="item_wrap">
                                        ...
                                        <figcaption class="item-info">
                                            ...
                                            <a href="<?php the_permalink(); ?>" class="item-more"><img style="position: relative;    left: 1100px;top: -106px;width: 19px;"src="<?php echo get_template_directory_uri()?>/assets/images/news.png"></a>
                                        </figcaption>
                                    </figure>
                                </li>
                            <?php endwhile; ?>
