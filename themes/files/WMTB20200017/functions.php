...
function wpbeginner_numeric_posts_nav() {
    ...
    // 尾页
    echo '<a color: #444444 href="'.get_pagenum_link($max).'">Last</a>'. "\n";
    echo '</div></div>' . "\n";
...
// Add the Home link
        ...
        if ( is_category() )
        {
            ...
            foreach ( $a_link_array as $item ) {
                echo '<li class="current">'.$item.'</li>';
            }
            /* echo '<li class="current">'.$a_link_array[count($a_link_array) -1].'</li>'; */
        }elseif ( is_tag() ) {

            echo "<li class='current'style='color: #d10445;padding-left:4px;'><a href='#'>Tags</a></li>";
        }
        elseif ( is_archive() && !is_category() )
        {
            echo "<li style='padding: 0 7px;'>Archives</li>";
        }
        elseif ( is_search() ) {

     
            echo "<li class='current'style='color: #d10445;padding-left:4px;'><a href='#'>Search Results</a></li>";
        }
        ...
        elseif ( is_single() )
        {
            ...
            // echo '<li class="current">'.$a_link_array[count($a_link_array) -1].'</li>';
            echo "<li style='padding: 0 7px;line-height:40px'><strong>" .the_title('','', FALSE)."</strong></li>";
        }
        elseif ( is_page() )
        {
            ...
            if ( $post->post_parent == 0 ){
                ...
                echo "<li style='padding: 0 7px;'><strong>".the_title('','', FALSE)."</strong></li>";
...
function get_href_lang($cat)
{
    ...
    foreach($currents as $current){
        ...
        echo "<link rel='alternate' hreflang0='{$current['abbr']}' href='{$http}{$_SERVER['HTTP_HOST']}{$current['link']}' />";
    };
}
